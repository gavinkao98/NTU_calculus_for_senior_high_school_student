...
\begin{envdefinition}{Definition}{C.1}{}
...
\begin{envproposition}{Proposition}{C.1}{Determinant as signed measure}
...
\begin{envdefinition}{Definition}{C.2}{}
...
\begin{envdefinition}{Definition}{C.3}{}
...
\end{envdefinition}
\begin{envproposition}{Proposition}{C.3}{Definiteness test}
